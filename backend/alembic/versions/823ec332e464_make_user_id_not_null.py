    ...
    if is_sqlite:
        ...
        with op.batch_alter_table("videos", schema=None) as batch_op:
            batch_op.alter_column(
                "user_id", nullable=False, existing_type=sa.String(36)
            )
        ...
        op.alter_column(
            "videos", "user_id", nullable=False, existing_type=sa.String(36)
        )
        op.alter_column(
            "players", "user_id", nullable=False, existing_type=sa.String(36)
        )
...
def downgrade() -> None:
    ...
    if is_sqlite:
        ...
        op.alter_column(
            "players", "user_id", nullable=True, existing_type=sa.String(36)
        )
