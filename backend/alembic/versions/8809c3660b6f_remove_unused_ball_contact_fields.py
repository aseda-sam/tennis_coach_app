...
def downgrade() -> None:
    ...
    op.add_column(
        "ball_contacts", sa.Column("ball_size_factor", sa.Float(), nullable=True)
    )
    ...
    op.add_column(
        "ball_contacts", sa.Column("ball_racket_distance", sa.Float(), nullable=True)
    )
    ...
    op.add_column(
        "ball_contacts", sa.Column("ball_position", sa.String(), nullable=True)
    )
    op.add_column(
        "ball_contacts", sa.Column("player_position", sa.String(), nullable=True)
    )
