...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_ball_detections_id"), "ball_detections", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_pose_detections_id"), "pose_detections", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_pose_detections_video_id"),
        "pose_detections",
        ["video_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_video_players_pose_detection_id"), table_name="video_players"
    )
