...
class TestBallContactPlayerIntegration:
    ...
    def test_create_ball_contact_with_player(self, db_session: Session):
    ...
    def test_create_ball_contact_without_player(self, db_session: Session):
    ...
    def test_create_ball_contact_invalid_player(self, db_session: Session):
    ...
    def test_update_ball_contact_player(self, db_session: Session):
    ...
    def test_update_ball_contact_remove_player(self, db_session: Session):
        """Test updating a ball contact to remove player assignment."""
        # Create player
        player_data = {"name": "Test Player", "dominant_hand": "right", "backhand_style": "two_handed"}
        player_response = client.post("/v0/players/", json=player_data)
        player_id = player_response.json()["id"]
    ...
    def test_get_ball_contacts_by_player(self, db_session: Session):
    ...
    def test_get_ball_contacts_by_player_not_found(self, db_session: Session):
    ...
    def test_get_ball_contacts_by_video_with_players(self, db_session: Session):
    ...
    def test_delete_player_cascades_to_ball_contacts(self, db_session: Session):
