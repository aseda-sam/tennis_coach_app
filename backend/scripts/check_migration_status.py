...
def check_migration_status() -> None:
    ...
    try:
        ...
        try:
            ...
            print("   This might indicate RLS or permissions issue")
        ...
        try:
            ...
            if rls_info:
                ...
                if rls_info[1]:
                    print(
                        "   ⚠️  RLS is enabled - check if Alembic has proper permissions"
                    )
            else:
                print("   ⚠️  Could not find alembic_version table info")
        except Exception as e:  # noqa: BLE001
            # Might be SQLite
            if "pg_tables" in str(e):
                print(f"   ℹ️  Not PostgreSQL (or RLS check failed): {e}")  # noqa: RUF001
            else:
        ...
        try:
            ...
            print("   ✅ Can read alembic_version table")
        except Exception as e:  # noqa: BLE001
            print(f"   ❌ Cannot read alembic_version: {e}")
            print("   This suggests RLS or permissions issue")
