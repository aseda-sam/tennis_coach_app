...
export const ExportIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      d="M19 12v7H5v-7H3v7c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-7h-2zm-6 .67l2.59-2.58L17.5 11.5 12 17l-5.5-5.5 1.41-1.41L11 12.67V3h2z"
      fill={color}
    />
  </svg>
);
...
export const FrameExtractionIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
export const PoseDetectionIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
export const VideoAnnotationIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
  ...
  >
    <path
      ...
      fill={color}
    />
    <path d="M8 8h8v2H8V8zm0 4h6v2H8v-2z" fill={color} />
  </svg>
);
...
export const BodyTrackingIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
  ...
  >
    ...
    <path
      d="M20.5 6c-2.61.7-5.67 1-8.5 1s-5.89-.3-8.5-1L3 8c1.86.5 4 .83 6 1v13h2v-6h2v6h2V9c2-.17 4.14-.5 6-1l-.5-2z"
      fill={color}
    />
  </svg>
);

export const ServeBreakdownIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
export const FrameStepIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
